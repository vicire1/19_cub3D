...
void	load_xpm(t_data *data)
{
	...
	data->txtr[NO].img = mlx_xpm_file_to_image(data->ptr, data->path_N, &w, &h);
	data->txtr[SO].img = mlx_xpm_file_to_image(data->ptr, data->path_S, &w, &h);
	data->txtr[WE].img = mlx_xpm_file_to_image(data->ptr, data->path_W, &w, &h);
	data->txtr[EA].img = mlx_xpm_file_to_image(data->ptr, data->path_E, &w, &h);
